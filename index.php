			...
			<div id="frame_enemies">
				...
				<div id="enemies_custom_list" class="frame_hero_main" style="display:none;">
					...
					<div class="frame_hero_main_right">
						<div class="bar_top_options"><select id="cl_enemy_name" data-var="enemies.cl.list.index"></select><div class="bar_top_options_right"><span class="bar_label">Rarity:</span><input id="cl_enemy_rarity" data-var="enemies.cl.list.rarity" type="number" class="rarityinput smallnuminput cl_enemy_standardhero" value=5 min=1 max=5 /><span class="bar_label">Lvl 40+</span><input id="cl_enemy_merge" data-var="enemies.cl.list.merge" class="smallnuminput cl_enemy_standardhero" type="number" value=0 min=0 max=10 /><div class="button reset_button reset_enemies" id="reset_cl_enemy">Reset</div></div></div>
						<div class="frame_hero_main_top">
							<div class="frame_hero_picture"><img class="hero_picture cl_enemy_standardhero" id="cl_enemy_picture" src="heroes/nohero.png"/><img id="cl_enemy_weapon_icon" class="weaponIcon" src="weapons/noweapon.png"/>
								<div class="cl_enemy_customhero">
									<div class="customattribute_row">Weapon type: 
										<select id="cl_enemy_customweapon" data-var="enemies.cl.list.weaponType">
									...
									<div class="customattribute_row">Move type: 
										<select id="cl_enemy_custommove" data-var="enemies.cl.list.moveType">
							...
							<div class="frame_stats">
								<div class="bufflabel">Buff</div><div class="debufflabel">Debuff</div><div class="spurlabel">Spur</div>
								<div class="stat_row">HP: <span class="stat_number cl_enemy_standardhero" id="cl_enemy_hp">-</span><input id="cl_enemy_inputhp" class="smallnuminput customstatinput cl_enemy_customhero" type="number" value=30 min=0 data-var="enemies.cl.list.hp" /></div>
								<div class="stat_row">Atk: <span class="stat_number cl_enemy_standardhero" id="cl_enemy_atk">-</span><input id="cl_enemy_inputatk" class="smallnuminput customstatinput cl_enemy_customhero" type="number" value=30 min=0 data-var="enemies.cl.list.atk" /><input id="cl_enemy_atk_buff" data-var="enemies.cl.list.buffs.atk" class="buff_input smallnuminput" type="number" value=0 min=0 max=7 /><input id="cl_enemy_atk_debuff" data-var="enemies.cl.list.debuffs.atk" class="debuff_input smallnuminput" type="number" value=0 min=-7 max=0 /><input id="cl_enemy_atk_spur" data-var="enemies.cl.list.spur.atk" class="spur_input smallnuminput" type="number" value=0 min=0 max=24 /></div>
								<div class="stat_row">Spd: <span class="stat_number cl_enemy_standardhero" id="cl_enemy_spd">-</span><input id="cl_enemy_inputspd" class="smallnuminput customstatinput cl_enemy_customhero" type="number" value=30 min=0 data-var="enemies.cl.list.spd" /><input id="cl_enemy_spd_buff" data-var="enemies.cl.list.buffs.spd" class="buff_input smallnuminput" type="number" value=0 min=0 max=7 /><input id="cl_enemy_spd_debuff" data-var="enemies.cl.list.debuffs.spd" class="debuff_input smallnuminput" type="number" value=0 min=-7 max=0 /><input id="cl_enemy_spd_spur" data-var="enemies.cl.list.spur.spd" class="spur_input smallnuminput" type="number" value=0 min=0 max=24 /></div>
								<div class="stat_row">Def: <span class="stat_number cl_enemy_standardhero" id="cl_enemy_def">-</span><input id="cl_enemy_inputdef" class="smallnuminput customstatinput cl_enemy_customhero" type="number" value=30 min=0 data-var="enemies.cl.list.def" /><input id="cl_enemy_def_buff" data-var="enemies.cl.list.buffs.def" class="buff_input smallnuminput" type="number" value=0 min=0 max=7 /><input id="cl_enemy_def_debuff" data-var="enemies.cl.list.debuffs.def" class="debuff_input smallnuminput" type="number" value=0 min=-7 max=0 /><input id="cl_enemy_def_spur" data-var="enemies.cl.list.spur.def" class="spur_input smallnuminput" type="number" value=0 min=0 max=24 /></div>
								<div class="stat_row">Res: <span class="stat_number cl_enemy_standardhero" id="cl_enemy_res">-</span><input id="cl_enemy_inputres" class="smallnuminput customstatinput cl_enemy_customhero" type="number" value=30 min=0 data-var="enemies.cl.list.res" /><input id="cl_enemy_res_buff" data-var="enemies.cl.list.buffs.res" class="buff_input smallnuminput" type="number" value=0 min=0 max=7 /><input id="cl_enemy_res_debuff" data-var="enemies.cl.list.debuffs.res" class="debuff_input smallnuminput" type="number" value=0 min=-7 max=0 /><input id="cl_enemy_res_spur" data-var="enemies.cl.list.spur.res" class="spur_input smallnuminput" type="number" value=0 min=0 max=24 /></div>
							</div>
						</div>
						<div class="frame_hero_main_bottom">
							<div class="hero_skills">
